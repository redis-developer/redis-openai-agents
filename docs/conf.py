...
from redis_openai_agents import __version__

project = 'Redis OpenAI Agents'
...
html_title = "Redis OpenAI Agents"
html_context = {
   "default_mode": "dark"
}
...
html_context = {
    "github_user": "redis",
    "github_repo": "redis-openai-agents",
    "github_version": "main",
    "doc_path": "docs",
}
html_sidebars = {
...
html_theme_options = {
    "logo": {
        "text": "Redis OpenAI Agents",
        "image_dark": "_static/Redis_Logo_Red_RGB.svg",
        "alt_text": "Redis OpenAI Agents",
    },
    ...
    "icon_links": [
        {
            "name": "GitHub",
            "url": "https://github.com/redis/redis-openai-agents",
...
# -- Options for autoapi -------------------------------------------------------
autoapi_type = "python"
autoapi_dirs = ["../src/redis_openai_agents"]
